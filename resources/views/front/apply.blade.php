        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <form class="submit-form-data ptb30 form-area" action="apply-now" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="input-wrap get-in-touch col-md-6 col-sm-6">
                                <input type="text" id="name" class="general_input italic input-field" placeholder="Full name" name="name" >
                            </div>
                            <div class="input-wrap get-in-touch col-md-6 col-sm-6">
                                <input type="email" id="email" class="general_input italic input-field" placeholder="Email address" name="email" >
                            </div>
                            <div class="input-wrap get-in-touch col-md-6 col-sm-6">
                            ...
                            <div class="input-wrap get-in-touch col-md-6 col-sm-6">
                                <input type="text" id="applyfor" class="general_input italic input-field" placeholder="Job Or Intern" name="applyfor">
                            ...
                            <div class="input-wrap get-in-touch col-md-12">
                                <textarea class="general_input italic input-field w-93" id="message" placeholder="Write Something About You" name="msg"></textarea>
                            </div>
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <p class=" text-left">A video game designer turns the concept of a game into a playable
                        ...
                        and knowledge about the video game industry.
                   ...
                   <!--           <p>&nbsp;</p>-->
                    ...
                    <p>&nbsp;</p>
                    <p class="text-left"><strong>Weekend: </strong>Friday
