...
<div class="container">
    <h2>Manage Sociallink</h2>
    @if (Session::has('message_sent'))
<div class="alert alert-success" roll="alert">
    {{ Session::get('msg') }}
</div>
@endif
    <form method="post"  action="{{ route('admin.sociallink.update', $data->id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
                <input type="text" name="twitter" class="form-control" value="twitter" placeholder="Twitter">
                    @error('twitter')
                        {{$message}}
                        @enderror
            </div> 
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
                <input type="text" name="insta" class="form-control" value="insta" placeholder="Instagram">
                    @error('insta')
                        {{$message}}
                        @enderror
            </div> 
